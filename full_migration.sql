ALTER ROLE authenticator SET "pgrst.db_schemas" TO 'public,storage,graphql_public,mts,prodis,prospector,bunker,coeus,madetoscale';
CREATE SCHEMA IF NOT EXISTS coeus;
GRANT USAGE ON SCHEMA coeus TO authenticator, anon, authenticated;
...
GRANT ALL ON ALL FUNCTIONS IN SCHEMA coeus TO authenticator, anon, authenticated;
